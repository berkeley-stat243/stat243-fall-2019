...
There are 2 conflicts that are common when working with multiple people or on 
multiple machines.  
  * Remote repo is ahead of your local one
  * Collaborator modified the same lines of a files as you
